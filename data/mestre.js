...
const NOMES_SILABAS = {
  ...
  "Dahllan": {ini:["Bri","Fol","Gali","Lir","Mai","Nea","Sil","Vi","Yara"], meio:["a","ie","ol","ea","ori"], fim:["wen","lis","ora","ith","ana","iel"]},
  "Lefou": {ini:["Ashk","Drem","Gash","Krev","Morr","Nekt","Skarr","Vrix"], meio:["a","o","ii","ur","ok"], fim:["gash","noth","ux","ith","ok","ash"]},
  "Minotauro": {ini:["Bruk","Duro","Gorr","Karg","Morn","Tharo","Uk","Vondar"], meio:["a","o","ar","or"], fim:["nak","tor","gar","dun","rok","mak"]},
  "Qareen": {ini:["Adi","Basim","Faris","Jalil","Kadir","Nadir","Rashi","Sami","Zahir"], meio:["a","i","ir","al","ei"], fim:["din","far","zad","rim","ash","el"]},
  "Golem": {ini:["Un","Dez","Tri","Kva","Pen","Hex","Sep","Okt"], meio:["a","i","o"], fim:["-01","-02","-7","-Alfa","-Prime","-Zero","-9"]},
  "Hynne": {ini:["Bili","Cori","Dodi","Fena","Josi","Meli","Pipin","Rosi","Toli"], meio:["a","e","i","ie"], fim:["po","din","gal","lin","ny","bo","ta"]},
  "Kliren": {ini:["Chik","Klik","Nirr","Pitt","Skiv","Trik","Vik","Zir"], meio:["i","e","ee"], fim:["tik","riz","kle","niv","ssk","zit"]},
  "Medusa": {ini:["As","Ekhi","Iss","Nag","Ophi","Sser","Vish","Zeth"], meio:["ss","i","a","eth"], fim:["ssa","xis","ara","eth","ith","yss"]},
  "Osteon": {ini:["Bran","Cael","Drys","Kest","Mordin","Ossi","Ryn","Thane"], meio:["o","e","a"], fim:["dris","mor","kel","vane","dos","rath"]},
  "Sereia/Tritão": {ini:["Amá","Coral","Isha","Kai","Mari","Nerin","Talassa","Vay"], meio:["a","i","ei","or"], fim:["mar","wen","lia","don","rin","essa"]},
  "Sílfide": {ini:["Aeri","Bris","Fael","Iri","Nimb","Ravi","Ventu","Zeph"], meio:["a","ee","i","ae"], fim:["wisp","ria","lis","ael","ura","ind"]},
  "Suraggel (Aggelus)": {ini:["Azri","Cael","Gabri","Micha","Rafa","Seraph","Uri","Zophi"], meio:["e","a","ie"], fim:["el","iel","ael","oth","ith"]},
  "Suraggel (Sulfure)": {ini:["Abad","Baal","Kroth","Malfi","Nezz","Vorak","Xael","Zagan"], meio:["a","o","ur","az"], fim:["oth","gar","nax","urak","eth","gul"]},
  "Trog": {ini:["Bok","Chur","Grum","Klak","Mudd","Rok","Vulg","Zog"], meio:["a","u","o"], fim:["ug","ak","um","og","urg","az"]},
  "Padrão": {ini:["Ar","El","Kor","Mal","Ry","Tal","Vin","Za"], meio:["a","e","i","o","u"], fim:["nor","ris","dan","mir","lok","tha"]},
};

const TRACOS_PERSONALIDADE_NPC = [
  "Fala sempre em voz baixa, como se contasse segredos",
  "Ri de tudo, até das próprias desgraças",
  "Extremamente supersticioso — evita passar sob escadas, sal derramado etc.",
  "Guloso, sempre comendo alguma coisa no meio da conversa",
  "Desconfia de estranhos até prova em contrário",
  "Fala rápido demais e se atrapalha com as palavras",
  "Colecionador obsessivo de algo estranho (botões, pedras, insetos mortos)",
  "Extremamente educado, até com quem claramente não merece",
  "Nunca olha nos olhos de quem conversa",
  "Adora fofoca e sabe de tudo que acontece na região",
  "Teimoso, nunca admite estar errado sobre nada",
  "Generoso ao extremo, dá tudo que tem pra quem pedir",
  "Extremamente pontual, se irrita com atrasos alheios",
  "Fala de si na terceira pessoa",
  "Sempre otimista, mesmo em situações desesperadoras",
  "Carrega um amuleto/talismã e toca nele quando nervoso",
  "Odeia silêncio, preenche qualquer pausa na conversa",
  "Trata animais melhor que gente",
  "Guarda rancor por décadas de qualquer ofensa pequena",
  "Nunca aceita ajuda, mesmo quando precisa desesperadamente",
];
const SEGREDOS_NPC = [
  "Está endividado com a pessoa errada",
  "É parente distante de alguém importante e esconde isso",
  "Já cometeu um crime há anos e ninguém nunca soube",
  "Está apaixonado(a) por alguém que não pode/deve amar",
  "Sabe onde está escondido um tesouro ou item valioso",
  "Trabalha secretamente pra uma facção rival da que aparenta servir",
  "Fugiu de outra cidade e mudou de nome pra não ser encontrado",
  "Tem uma doença ou maldição que esconde de todos",
  "Já traiu um amigo próximo por dinheiro, e se arrepende",
  "Na verdade não é da raça/profissão que aparenta ser",
  "Guarda uma carta/objeto de alguém que morreu e nunca entregou",
  "Sabe de um assassinato e ficou calado por medo",
  "É informante pago de alguém no submundo local",
  "Tem um filho ou parente que ninguém sabe que existe",
  "Planeja fugir da cidade assim que juntar dinheiro suficiente",
];
function sortearNpcCompleto(racaChave){
  return {
    nome: gerarNome(racaChave),
    raca: racaChave,
    traco: sortear(TRACOS_PERSONALIDADE_NPC),
    segredo: sortear(SEGREDOS_NPC),
  };
}
